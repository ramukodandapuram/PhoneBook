...
class BaseViewTest(APITestCase):
    ...
    def create_contact(name="", phone_number=""):
        if name != "" and phone_number != "":
            ContactDetails.objects.create(name=name, phone_number=phone_number)
    ...
    def setUp(self):
        ...
        # add test data
        self.create_contact("ramu", "8945949494")
        self.create_contact("rajesh", "485393499")
        self.create_contact("ramesh", "89459494")
        self.create_contact("ravi", "89459494")
...
class GetAllContactsTest(BaseViewTest):
    ...
    def test_get_all_contacts(self):
        ...
        expected = ContactDetails.objects.all()
        serialized = ContactDetailsSerializer(expected, many=True)
